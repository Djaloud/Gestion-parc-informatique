...
<div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-top" role="navigation">
			...
			<form class=" navbar-left-right" method="POST" action="">
 	...
 	<!---->
        ...
        <form method="post" action="aprover.php">
         	<div class="vali-form">
*
            ...
            <div class="col-md-12 form-group1 group-mail">
              ...
              <input type="date" class="form-control1 ng-invalid ng-invalid-required"  name="date" required>
            </div>
            <div class="clearfix"> </div>
            </div>
            ...
            <div class="col-md-12 form-group1 group-mail">
              ...
              <input type="text" placeholder="cout" name="cout" required>
            </div>
             <div class="clearfix"> </div>
             <div class="col-md-12 form-group1 ">
              <label class="control-label">Your Comment</label>
              <textarea  placeholder="Your Comment..." name="comment" required>Your Comment.....</textarea>
            </div>
             <div class="clearfix"> </div>
